...
const Sidebar = () => {
  ...
  const sideBarTailwindClass = `bg-blue-300 text-black h-screen px-4 fixed w-44 md:w-64 z-10 transition-transform duration-500 ease-in-out flex flex-col justify-between ${
  ...
  return (
    <>
        ...
        <button
          onClick={toggleOpen}
          className="fixed top-4 left-4 z-20 px-2 bg-white border border-black  rounded md:hidden"
        >
          {isOpen ? "X" : "≣"}
        </button>
        ...
        <div className={sideBarTailwindClass}>
          ...
          <ul className="flex flex-col mt-5 text-sm">
            <li className=" my-2 font-bold py-2 px-1 hover:text-white hover:bg-blue-500 hover:rounded-sm">
           ...
           <ul >
          <li className=" mt-[35rem] my-2 font-bold py-2 px-1 hover:text-white hover:bg-blue-500 hover:rounded-sm">
